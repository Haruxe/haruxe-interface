          ...
          <div className="max-w-5xl mx-auto">
                ...
                {job.responsibilities.map(
                  (responsibility: string, index: number) => (
                    <li key={index} className="flex items-start">
                      <span className="text-primary text-lg sm:text-xl mr-2 sm:mr-3">•</span>
            ...
            >
              <div className="mb-2 sm:mb-0">
                ...
                <p className="text-foreground font-medium text-sm sm:text-base">{job.date}</p>
              </div>
              ...
              <div className="mb-2 sm:mb-0">
                ...
                <p className="text-foreground font-medium text-sm sm:text-base">{job.title}</p>
              </div>
